# OpenSCAD Texture Tools for Ceramics
...
bash scripts powered by OpenSCAD to create custom texture rollers, stamps, and sprig molds from images

## Tools

1. [hollow cylindrical texture roller](https://github.com/disdyakis/ceramics-tools/tree/main/roller)
2. spherical texture roller (in progress...)
